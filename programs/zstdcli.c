...
static void usage_advanced(const char* programName)
{
    ...
    DISPLAYOUT( "--[no-]row-matchfinder : force enable/disable usage of fast row-based matchfinder for greedy, lazy, and lazy2 strategies \n");
    ...
    for (argNb=1; argNb<argCount; argNb++) {
        ...
        if (argument[0]=='-') {
            ...
            if (argument[1]=='-') {
                ...
                if (!strcmp(argument, "--no-row-matchfinder")) { useRowMatchfinder = 1; continue; }
                if (!strcmp(argument, "--row-matchfinder")) { useRowMatchfinder = 2; continue; }
