...
/* SIMD SSE version */
#if !defined(ZSTD_NO_INTRINSICS) && defined(__SSE2__)
 ...
 * See: https://stackoverflow.com/questions/11870910/sse-mm-movemask-epi8-equivalent-method-for-arm-neon
 */ 
static U32 ZSTD_vmovmaskq_u8(ZSTD_Vec128 val) {
    /* shift out everything but the sign bits */
    uint16x8_t high_bits = vreinterpretq_u16_u8(vshrq_n_u8(val, 7));
    ...
    /* Extract the low 8 bits from each lane, join */
