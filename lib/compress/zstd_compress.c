...
typedef struct {
    ...
    U32 MLtype;
    size_t size;
} ZSTD_sequencesEncodingTypeStats;
 ...
 */
static ZSTD_sequencesEncodingTypeStats
ZSTD_buildSequencesStatistics(seqStore_t* seqStorePtr, size_t nbSeq, size_t* lastCountSize,
    ...
    U32 Offtype;
    U32 MLtype;
    ZSTD_sequencesEncodingTypeStats stats;
...
static size_t ZSTD_compressBlock_splitBlock_internal(ZSTD_CCtx* zc, void* dst, size_t dstCapacity,
    ...
    for (i = 0; i <= numSplits; ++i) {
        ...
        DEBUGLOG(2, "Estimated size: %zu actual size: %zu", ZSTD_buildEntropyStatisticsAndEstimateSubBlockSize(&currSeqStore, zc), cSizeChunk);
